...
import personal.basedxmppchat.task.LoginTask;
import personal.basedxmppchat.util.StringUtil;
import personal.basedxmppchat.util.ValidateUtil;
...
public class LoginActivity extends ActivitySupport {
    ...
    private boolean checkData(){
        ...
        checked = (!ValidateUtil.isEmpty(edt_username, "登录名"))
                && !ValidateUtil.isEmpty(edt_pwd,"密码");
        return checked;
    }
