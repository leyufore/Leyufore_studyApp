...
import personal.basedxmppchat.db.DBManager;
import personal.basedxmppchat.db.SQLiteTemplate;
import personal.basedxmppchat.db.SQLiteTemplate.RowMapper;
...
public class NoticeManager {
    ...
    private NoticeManager(Context context){
        SharedPreferences sharedPre = context.getSharedPreferences(
                Constant.LOGIN_SET,Context.MODE_PRIVATE);   //MODE_PRIVATE模式,只可以创建该sharedPre的应用可以访问该preference.
