...
/**
 * 该界面并不复杂,发现使用Animation有很大缺陷
 * 1.ImageVIew上进行动画时,得先使用clearAnimation才能正常使用
 * 2.快速在两个选项之间切换时,会导致视觉上的卡,而没有连续变化的视觉效果
 * 推荐使用Animator
 * learner : leyufore
 */
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()){
            case KeyEvent.KEYCODE_DPAD_UP:
                return controllManager(controller,UP,CONTROLL_DAY);
            case KeyEvent.KEYCODE_DPAD_DOWN:
                return controllManager(controller,DOWN,CONTROLL_DAY);
            case KeyEvent.KEYCODE_DPAD_LEFT:
                return controllManager(controller,LEFT,CONTROLL_DAY);
            case KeyEvent.KEYCODE_DPAD_RIGHT:
                return controllManager(controller,RIGHT,CONTROLL_DAY);
            case KeyEvent.KEYCODE_DPAD_CENTER:
//                return controllManager(controller,OK,CONTROLL_DAY);
                LogError.error("ok");
                setTwoAlarmSmallAnim(views[5]);
                break;
            default:
                break;
        }
    ...
    public void setTwoLargeAnim(View view){
        view.clearAnimation();
        //以底边中心作为缩放中心
        Animation animation = new ScaleAnimation(0.75f,1f,0.75f,1f,Animation.RELATIVE_TO_SELF,0.5f,Animation.RELATIVE_TO_SELF,1);
    ...
    public void setTwoAlarmSmallAnim(View view){
        LogError.error("pivotx pivoty " + view.getPivotX() + " " + view.getPivotY());
//        view.clearAnimation();
//        Animation animation = new ScaleAnimation(1f,0.75f,1f,0.75f,Animation.RELATIVE_TO_SELF,0.5f,Animation.RELATIVE_TO_SELF,1);
//        animation.setDuration(300);
//        animation.setFillAfter(true);
//        view.setAnimation(animation);
//        animation.start();
    ...
    public void setItemLargeAnim(View view){
        view.clearAnimation();
        //以图像中心作为缩放中心
        Animation animation = new ScaleAnimation(0.66f,1f,0.66f,1f,Animation.RELATIVE_TO_SELF,0.5f,Animation.RELATIVE_TO_SELF,0.5f);
        animation.setDuration(300);
        animation.setFillAfter(true);
        view.setAnimation(animation);
        animation.start();
...
//        animatorSet.start();
    ...
    public void setItemSmallAnim(View view){
        view.clearAnimation();
        //以图像中心作为缩放中心
        Animation animation = new ScaleAnimation(1f,0.66f,1f,0.66f,Animation.RELATIVE_TO_SELF,0.5f,Animation.RELATIVE_TO_SELF,0.5f);
        animation.setDuration(300);
        animation.setFillAfter(true);
        view.setAnimation(animation);
        animation.start();
